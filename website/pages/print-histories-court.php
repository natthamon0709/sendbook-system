...
FROM history WHERE id IN (' . $idsString . ') AND type=3
GROUP BY officer_id;
';
...
while ($row = $results->fetch_assoc()) {
  ...
  $findSql = "SELECT * FROM history WHERE officer_id=$officer_id AND id IN ($idsString) AND type=3";
